...
export const getUpdatedState = <S, P extends S, TMetaStatus extends MetaStatus>(state: S, payload: P | undefined | null, metaStatus: TMetaStatus, path: Path, actionId?: string, options?: Options<S, P>): UpdatedStatus<S, P> => {
